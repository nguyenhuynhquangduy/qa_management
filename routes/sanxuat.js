...
router.get("/delete-sanpham", isLoggedIn, logs, sanxuat.deleteSanPham);
router.post("/update-sanpham", isLoggedIn, logs, sanxuat.postUpdateSanPham);

router.get('/edit-sanpham', isLoggedIn, logs, sanxuat.getEditSanPham);
router.get('/api/get-thongtinphache', isLoggedIn, logs, sanxuat.getAPIthongTinPhaChe);
