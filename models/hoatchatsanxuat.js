...
module.exports = (sequelize, DataTypes) => {
  ...
  hoatchatsanxuat.init({
    ...
    dapVien_hoatan1_vien1: DataTypes.STRING,
    dapVien_hoatan1_vien2: DataTypes.STRING,
    dapVien_hoatan1_vien3: DataTypes.STRING,
    dapVien_hoatan1_vien4: DataTypes.STRING,
    dapVien_hoatan1_vien5: DataTypes.STRING,
    dapVien_hoatan1_vien6: DataTypes.STRING,
    dapVien_hoatan2_vien1: DataTypes.STRING,
    dapVien_hoatan2_vien2: DataTypes.STRING,
    dapVien_hoatan2_vien3: DataTypes.STRING,
    dapVien_hoatan2_vien4: DataTypes.STRING,
    dapVien_hoatan2_vien5: DataTypes.STRING,
    dapVien_hoatan2_vien6: DataTypes.STRING,
